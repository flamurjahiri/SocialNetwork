...
public class LoginPanel extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            String jTxt = jTextField1.getText();
            String password = String.valueOf(jPasswordField1.getPassword());
            SqlMesazhaFollowers cu = new SqlMesazhaFollowers();
            if(cu.getUser(jTxt.trim(), password)) {
                this.setVisible(false);
                if(cu.checkAdmin(jTxt.trim())) {
                    AdminPanel ap = new AdminPanel(jTxt.trim());
                }
                else{
                    UserPanel up = new UserPanel(jTxt.trim());
                }
            }
            else {
                JOptionPane.showMessageDialog(null, "Te dhenat gabim");
            }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        RegjistrohuPanel regjistrohu = new RegjistrohuPanel();
